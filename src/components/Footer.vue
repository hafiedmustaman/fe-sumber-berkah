        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Toko Online Produk Kesehatan Terpercaya di Surabaya. Jual Beli Aman & Harga Termurah! Belanja
                        sekarang.
                    </p>
                    <div class="social">
            ...
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Sumber Berkah Store</strong> 2020-{{ new Date().getFullYear() }} • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
